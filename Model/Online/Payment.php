...
namespace Saulmoralespa\JustPay\Model\Online;

use Magento\Payment\Model\Method\AbstractMethod;

class Payment extends  AbstractMethod
{
    const CODE = 'justpay_online';
    ...
    protected $_supportedCurrencyCodes = ['CLP', 'PEN', 'USD'];
    ...
    {
        if ($this->_helperData->getActiveOnline()) return true;
        return false;
    }
